function save_normaltest(populationSize, chromosomeSize, maxiter, p_cross, p_mutation, ...
                                 minDist, maxDist, elitismCount, alpha_sparsity, ...
                                 pslbest, actpos, sparsityLevel, illegalnum, elapsedTime,Stop_num)

    csv_filename = 'normaltest.csv';
    ...
    fprintf(fid, '%d,%d,%d,%.4f,%.4f,%.4f,%.4f,%d,%.4f,%.4f,%d,%.4f,%d,%.4f,%d \n', data);
    fclose(fid);
